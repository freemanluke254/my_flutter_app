...
class BriefingStorage {
  ...
  Map<String, Object?> _flightToJson(FlightBriefing flight) => {
    ...
    'alternateFuel': flight.alternateFuel,
    'finalReserveFuel': flight.finalReserveFuel,
    'etpAdjustmentFuel': flight.etpAdjustmentFuel,
    'minimumEtpRemainingFuel': flight.minimumEtpRemainingFuel,
    'additionalFuel': flight.additionalFuel,
    'unusableFuel': flight.unusableFuel,
    'arrivalDelayFuel': flight.arrivalDelayFuel,
    ...
    'calculatedRtow': flight.calculatedRtow,
    'airbusZfwCg': flight.airbusZfwCg,
    'airbusStabCg': flight.airbusStabCg,
    'maxPayloadPlan': flight.maxPayloadPlan,
    'finalZfwReceived': flight.finalZfwReceived,
    'preliminaryThrustSetting': flight.preliminaryThrustSetting,
    'preliminaryFlapSetting': flight.preliminaryFlapSetting,
    'preliminaryPerformanceComplete': flight.preliminaryPerformanceComplete,
    'efbPerformanceEntered': flight.efbPerformanceEntered,
    'finalLoadsheetReceived': flight.finalLoadsheetReceived,
    'actualTakeoffCg': flight.actualTakeoffCg,
    'finalThrustSetting': flight.finalThrustSetting,
    'finalFlapSetting': flight.finalFlapSetting,
    'finalPerformanceComplete': flight.finalPerformanceComplete,
    'atisLetter': flight.atisLetter,
    'atisPrintedAndRetained': flight.atisPrintedAndRetained,
    'loadsheetInitialized': flight.loadsheetInitialized,
    'regulatedLandingWeight': flight.regulatedLandingWeight,
    'regulatedWeightsSent': flight.regulatedWeightsSent,
    'landingDispatchRequired': flight.landingDispatchRequired,
    'landingDispatchAnswered': flight.landingDispatchAnswered,
    'flightDeckCount': flight.flightDeckCount,
    'cabinCrewCount': flight.cabinCrewCount,
    'captainPayrollNumber': flight.captainPayrollNumber,
    'fsm': flight.fsm,
    'css': flight.css,
    'stand': flight.stand,
  ...
  FlightBriefing _flightFromJson(Map<String, Object?> json) => FlightBriefing(
    ...
    alternateFuel: json['alternateFuel'] as String? ?? '',
    finalReserveFuel: json['finalReserveFuel'] as String? ?? '',
    etpAdjustmentFuel: json['etpAdjustmentFuel'] as String? ?? '',
    minimumEtpRemainingFuel: json['minimumEtpRemainingFuel'] as String? ?? '',
    additionalFuel: json['additionalFuel'] as String? ?? '',
    unusableFuel: json['unusableFuel'] as String? ?? '',
    arrivalDelayFuel: json['arrivalDelayFuel'] as String? ?? '',
    ...
    calculatedRtow: json['calculatedRtow'] as String? ?? '',
    airbusZfwCg: json['airbusZfwCg'] as String? ?? '',
    airbusStabCg: json['airbusStabCg'] as String? ?? '',
    maxPayloadPlan: json['maxPayloadPlan'] as bool? ?? false,
    finalZfwReceived: json['finalZfwReceived'] as bool? ?? false,
    preliminaryThrustSetting: json['preliminaryThrustSetting'] as String? ?? '',
    preliminaryFlapSetting: json['preliminaryFlapSetting'] as String? ?? '',
    preliminaryPerformanceComplete:
        json['preliminaryPerformanceComplete'] as bool? ?? false,
    efbPerformanceEntered: json['efbPerformanceEntered'] as bool? ?? false,
    finalLoadsheetReceived: json['finalLoadsheetReceived'] as bool? ?? false,
    actualTakeoffCg: json['actualTakeoffCg'] as String? ?? '',
    finalThrustSetting: json['finalThrustSetting'] as String? ?? '',
    finalFlapSetting: json['finalFlapSetting'] as String? ?? '',
    finalPerformanceComplete:
        json['finalPerformanceComplete'] as bool? ?? false,
    atisLetter: json['atisLetter'] as String? ?? '',
    atisPrintedAndRetained: json['atisPrintedAndRetained'] as bool? ?? false,
    loadsheetInitialized: json['loadsheetInitialized'] as bool? ?? false,
    regulatedLandingWeight: json['regulatedLandingWeight'] as String? ?? '',
    regulatedWeightsSent: json['regulatedWeightsSent'] as bool? ?? false,
    landingDispatchRequired: json['landingDispatchRequired'] as bool? ?? false,
    landingDispatchAnswered: json['landingDispatchAnswered'] as bool? ?? false,
    flightDeckCount: json['flightDeckCount'] as int? ?? 3,
    cabinCrewCount: json['cabinCrewCount'] as int? ?? 10,
    captainPayrollNumber: json['captainPayrollNumber'] as String? ?? '',
